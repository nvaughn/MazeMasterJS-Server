...
class DAL_NeDb {
    ...
    static getInstance() {
        if (!DAL_NeDb.instance) {
            DAL_NeDb.instance = new DAL_NeDb();
        }
        return DAL_NeDb.instance;
    }
    ...
    getDocument(targetDb, objectId, callback) {
        ...
        tDb.findOne({ id: objectId }, function (err, doc) {
            ...
            if (doc && COMPRESSION_ENABLED)
                doc = DAL_NeDb.getInstance().decompressDocument(doc);
...
exports.DAL_NeDb = DAL_NeDb;
exports.default = DAL_NeDb;
//# sourceMappingURL=DAL_Local.js.map